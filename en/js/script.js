...
Vue.component('banner', {
  template: `<div id='index-header' class='header-strip'>
    <span id="header-info">
      <a v-for="img in americanFlag" v-bind:href='img.url'><span id='header-name'>{{ <img src=americanFlag.flag' id='flag-img' /> }}</span></a>
      <a v-for="img in frenchFlag" v-bind:href='img.url'><span id='header-name'>{{ <img src=frenchFlag.flag' id='flag-img' /> }}</span></a>
      <a v-for="img in polishFlag" v-bind:href='img.url'><span id='header-name'>{{ <img src=polishFlag.flag' id='flag-img' /> }}</span></a>
