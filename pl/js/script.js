...
new Vue({
  ...
  data: {
    writing: [
      { title: 'The Tools and Tips of Immersive Learning', img: '../../img/travelMap.jpeg', article: pagePrepend + 'The Tools and Tips of Immersive Learning with Revisions.html', description: 'Ten artykuł opiera się na obserwacjach oraz eksperymentowanie podczas moich pierwszych czterech miesięcy w Polsce. Podczas gdy się uczyłem polskiego, nigdy nic nie znalazłem w internecie o tym, jak się najlepszy uczyć języka w środowisku wciągającym, dlatego postanowiłem sam napisać artykuł o temacie. Z początku zrobiłem to, żeby wręczać na konferencjach językowach.' },
